...
#this program will download all game data from a specific day if you forget
#put how many days ago you're looking for below in "days_ago"
...
with app.app_context():
    ...
    yesterday = current_date - timedelta(days_ago)
